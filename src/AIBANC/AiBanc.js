  ...
  return (
    <div className="aibanc_container">
      ...
      <header>
        ...
        <div>
          <img src="/images/aibancBg.svg" className="aibancBg" alt="aibancBg" />
        </div>
      </header>
        ...
        <div className="left">
          ...
          <div>
            <p className="text_description">
              ...
              income earners gain quick, convenient, and secure access to credit
              that they deserve.
            </p>
            <p className="text_white">
              <span className="highlight">I was the the sole designer,</span>I
              collaborated with a team of four (4) developers with feedback from
              stakeholders
            </p>
          </div>
        </div>
        ...
        <div className="objective_display">
          ...
          <div className="obj_item">
            ...
            <ul className="obj_text">
              ...
              <li>
                To design a solution that enables a seamless credit liquidation
              </li>
      ...
      <section className="solutions_container">
        ...
        <p className="solution_text">
          Stakeholders were conducting transactions manually using paper, emails
          and excel for documentation. This made reconcilation difficult. Credit
          request was stressfull as paper documents had to be signed first
        </p>
