      ...
      <div className="borderless_cont">
          ...
          <div className="project_overview">
            ...
            <div className="overview_writeup">
              <p className="p3">
                ...
                businesses complete visibility of their candidates, manage
                hiring process and save valuable time. BorderlessHR has been
                specifically designed to meet the unique needs of today’s global
                workforce, helping companies grow their teams faster and more
            ...
            <div className="questions">
              <div className="question1">
                How might we enhance the profile-creating process for
                candidates?
              </div>
        ...
        <div className="problem_diagnosis">
          <div className="problem_cont">
            ...
            <p className="p7">
              Our research first centered around understanding the experiences
              of
              <br className="br" /> the people currently using the web app,
              issues they are facing, and why they have incomplete profiles. I
              formulated questions for an online survey that 28 people answered.
          ...
          <div className="result_cont">
            <div className="session1">
              ...
              <p className="p8">
                ...
                attributes, pain points, motivations, goals, and
                responsibilities.{" "}
              </p>
            </div>
        ...
        <div className="desigh_solution">
          <div className="solutions">
            ...
            <img
              src="/images/borderless5.png"
              className="solution_pix"
              alt=""
            />
            <img
              src="/images/borderless6.png"
              className="solution_pix"
              alt=""
            />
            <img
              src="/images/borderless7.png"
              className="solution_pix"
              alt=""
            />
            <img
              src="/images/borderless8.png"
              className="solution_pix"
              alt=""
            />
            <img
              src="/images/borderless9.png"
              className="solution_pix"
              alt=""
            />
          </div>
        ...
        <div className="validating_solution">
          <div className="validation_cont">
            <div className="validation1">
              ...
              <p>
                <span>Rewind</span> was used as usability testing tool, on
                rewind we could see how users interacted with the web app and
                what page has the most drop offs. With <span>Rewind</span> we
                noticed a significant percent of users did not make it pass the
                onboarding stage.
              </p>

              <p>
                We conducted interview with 6 talents who recent sign up and
                left mid way and below are our findings
              </p>
            </div>
          </div>
          ...
          <div className="validation_cont">
            <div className="validation2">
              ...
              <p>
                ...
                <ol>
                  <li>
                    Streamline the requirement for account creation to fit what
                    is obtainable from resume
                  </li>
                  <li>
                    The most important information should be gotten at the
                    onboarding and the rest can be gotten after a successful
                    sign up
                  </li>
        ...
        <div className="desigh_solution">
          <div className="solutions">
            <h3>Design solution</h3>
            <img
              src="/images/borderless11.png"
              className="solution_pix"
              alt=""
            />
            <img
              src="/images/borderless12.png"
              className="solution_pix"
              alt=""
            />
          </div>
